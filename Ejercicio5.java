...
public class Ejercicio5 {
	...
	public static void main(String args[]) {
		...
		System.out.println("*** Cúantas personas desea ingresar: ***");
		n = scanner.nextInt();

		for (i=1;i<=n;i++) {
			System.out.println("*** Registro "+i+") Ingrese la edad: ***");
			e = scanner.nextInt();
			System.out.println("*** Registro "+i+") Ingrese el sexo (f = femenino, m = masculino): *** ");
			s = scanner.next();

			if ((e>=1) && (e<=100)) {
				if ((e>=18) && (s.equals("f"))) {
					conteo_m++;
					System.out.println(" Mujer Mayor contabilizada ");
				}
				if ((e<=18) && (s.equals("m"))) {
					conteo_h++;
					System.out.println(" Hombre menor contabilizado ");
					System.out.println("\n");
				}
